...
export const Hero = () => {
  return <section className="relative min-h-[80vh] md:min-h-[90vh] flex items-center overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <img src={heroBanner} alt="Rivervox Premium Fashion" className="w-full h-full object-cover" />

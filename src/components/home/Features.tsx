...
import { Truck, Shield, RefreshCw, Headphones, Heart, Star, Clock, Gift, Zap, Award } from 'lucide-react';
import { cn } from '@/lib/utils';
import { useSiteContent } from '@/hooks/useSiteContent';

const iconMap: Record<string, React.FC<any>> = {
  Truck, Shield, RefreshCw, Headphones, Heart, Star, Clock, Gift, Zap, Award,
};
...
export const Features = () => {
  const { content } = useSiteContent('home', 'features', defaultFeatures);
